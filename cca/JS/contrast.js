    ...
    switch (Number(document.getElementById('copyCriteria').value)) {
      ...
      case 2:
        ...
        case 3:
          ...
          copyColor("Link or Button text on focus / hover","Background",msg3);
          break;
        case 4:
        ...
        case 16:
          ...
          break;   
        case 17:
          let msg17="The visual focus indicator of an element must have a minimum contrast ratio of 3:1 with both its inner and outer backgrounds. Based on the color codes below, the current visual focus indicator fails to meet the required contrast ratio with one of the adjacent colors, making it difficult for colorblind and low-vision users to identify the focused element."
          ...
          copyColor("Focus indicator","Adjacent",msg17);
          break; 
        case 18:
